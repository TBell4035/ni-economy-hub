    ...
    <div style={{maxWidth:1100}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:10,marginBottom:20}}>
        {(Object.entries(CATEGORY_CONFIG) as [keyof typeof CATEGORY_CONFIG, typeof CATEGORY_CONFIG[keyof typeof CATEGORY_CONFIG]][]).map(([k,v])=>(
          <div key={k} style={{background:T.card,border:`1px solid ${v.borderColor}`,borderTop:`2px solid ${v.color}`,borderRadius:0,padding:'12px 14px'}}>
            <div className="mono" style={{fontSize:12,color:v.color,marginBottom:4}}>{k}</div>
            <div style={{fontSize:12,color:T.text2,lineHeight:1.5}}>{v.description}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{display:'flex',gap:16,flexWrap:'wrap',marginBottom:20}}>
        <div>
          <div className="mono" style={{fontSize:12,color:T.text3,marginBottom:6}}>MODULE</div>
        ...
        <div>
          <div className="mono" style={{fontSize:12,color:T.text3,marginBottom:6}}>ALIGNMENT</div>
        ...
        <div>
          <div className="mono" style={{fontSize:12,color:T.text3,marginBottom:6}}>CATEGORY</div>
          <div style={{display:'flex',gap:4,flexWrap:'wrap'}}>
            {CATEGORIES.map(c=>(
      ...
      {/* Feed */}
      {loading ? (
        <div style={{color:T.text3,fontFamily:'var(--font-mono)',fontSize:14,padding:'20px 0'}}>Loading feed...</div>
      ) : (
        <div style={{marginBottom:32}}>
          {filtered.length===0 && (
            <div style={{color:T.text3,fontFamily:'var(--font-mono)',fontSize:14,padding:'20px 0'}}>
            ...
            return (
              <div key={i} style={{
                ...
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:10,flexWrap:'wrap',gap:8}}>
                  <div>
                    <div style={{fontSize:14,fontWeight:700,color:T.text0,marginBottom:2}}>{e.title}</div>
                    <div className="mono" style={{fontSize:12,color:T.text3}}>{e.source_name} · {e.published_date}</div>
                  </div>
                  <div style={{display:'flex',gap:6,flexShrink:0,flexWrap:'wrap'}}>
                    ...
                    <span style={{
                      ...
                      color:T.text3,padding:'2px 8px',borderRadius:0,
                      fontSize:12,fontFamily:'var(--font-mono)',letterSpacing:'0.04em',
                    }}>Q{e.source_quality}/5</span>
                  </div>
                </div>
                <p style={{fontSize:14,color:T.text2,lineHeight:1.65,marginBottom:10}}>{e.summary}</p>
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',flexWrap:'wrap',gap:8}}>
                  ...
                  <a href={e.url} target="_blank" rel="noopener noreferrer"
                    style={{fontSize:12,color:T.teal,fontFamily:'var(--font-mono)',textDecoration:'none'}}>
                    Source →
                  </a>
                </div>
              </div>
        ...
        {!formsOpen ? (
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
            <input
              ...
              style={{background:T.bg2,border:`1px solid ${T.border}`,borderRadius:0,padding:'8px 12px',color:T.text1,fontSize:14,fontFamily:'var(--font-mono)',outline:'none'}}
            />
            <input
            ...
            <textarea
              ...
              rows={4}
              style={{gridColumn:'1/-1',background:T.bg2,border:`1px solid ${T.border}`,borderRadius:0,padding:'8px 12px',color:T.text1,fontSize:14,fontFamily:'var(--font-mono)',outline:'none',resize:'vertical'}}
            />
            <button
              ...
              style={{
                ...
                padding:'10px',borderRadius:0,cursor:feedback.comment.trim()?'pointer':'default',
                fontSize:12,fontFamily:'var(--font-mono)',letterSpacing:'0.04em',transition:'all 0.15s',
              }}
            >
