...
const ChartCard = ({title,subtitle,children,fullWidth}:{
  ...
  <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:6,padding:20,gridColumn:fullWidth?'1/-1':undefined}}>
    ...
    <div style={{marginTop:14,borderTop:`1px solid ${T.border}`,paddingTop:14}}>
      <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:10}}>
        ...
        <div style={{flex:1,height:4,background:T.bg3,borderRadius:2}}>
          <div style={{width:`${confidence}%`,height:4,background:col,borderRadius:2,transition:'width 0.6s ease'}}/>
        </div>
...
export default function OutputPage() {
  ...
  return (
    <div style={{maxWidth:1100}} className="page-enter">
          ...
          <ChartCard title="Annual GVA Growth: NI vs UK vs ROI (%)" subtitle="2001–2026F · NISRA / ONS / CSO · FORECASTS SHADED">
            ...
            <ForecastBadge
              ...
              weaknesses={[
                ...
                "ROI 2015 figure (25.2%) is a multinational accounting artefact — treat with caution"
              ]}
          ...
          <ChartCard title="GVA Per Head: NI vs UK (£, nominal)" subtitle="ONS REGIONAL ACCOUNTS · 2004–2027F">
            ...
            <ForecastBadge
              ...
              weaknesses={[
                ...
                "2024 and 2025 ONS Regional Accounts not yet published — forecast period begins from 2024",
          ...
          <div style={{display:'flex',flexDirection:'column',gap:16}}>
            ...
            <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:6,padding:20}}>
              ...
              <div style={{
                ...
                <div style={{color:T.text3,fontSize:10,marginBottom:6}}>Δln(Y) = Δln(A) + α·Δln(K) + (1-α)·Δln(L)</div>
                ...
                <div style={{color:T.text3,fontSize:10,marginTop:8}}>
                  // α=capital share ~0.35 · K growth driven by construction boom<br/>
                  // L from LFS employment · TFP residual elevated by construction productivity
                </div>
              </div>
              <p style={{fontSize:12,color:T.text2,lineHeight:1.65}}>
                The unusually high TFP residual in 2024 is partly a statistical artefact of the
                construction boom — high output, high capital, modest employment growth. In
                trend years (2017–2019), the TFP residual was near zero, indicating NI's
                growth was almost entirely factor-accumulation driven. Sustained convergence
                with UK and ROI per-capita income requires structural TFP improvement —
                the hardest policy lever.
              </p>
            </div>

            <Insight type="insight" text="The GVA per head gap with the UK narrowed in 2023 to £6,866 (from over £8,000 in 2020). At current trajectory NI reaches £33,200 per head by 2027 against UK £39,000 — still 85% of UK average. Convergence is real but slow. At the current rate, full convergence with the UK average is approximately 40 years away without a structural productivity intervention." />
          </div>
        </div>
      )}
      ...
      {view==='sectors'&&(
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16}}>
          <ChartCard title="Turnover & GVA by Sector (£bn)" subtitle="NIABI 2024 · NISRA · PUBLISHED 11 MARCH 2026">
